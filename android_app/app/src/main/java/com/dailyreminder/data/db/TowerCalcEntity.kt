...
data class TowerCalcEntity(
    ...
    fun toModel() = com.dailyreminder.data.model.TowerCalc(
        id, number, data1, data2, data3, data4, resultLeftRight, resultForwardBack, createdAt
    )
    companion object {
        fun fromModel(m: com.dailyreminder.data.model.TowerCalc) = TowerCalcEntity(
            id = m.id, number = m.number, data1 = m.data1, data2 = m.data2,
            data3 = m.data3, data4 = m.data4,
